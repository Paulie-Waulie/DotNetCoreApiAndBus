namespace DotNetCoreApi.Configuration
{
    ...
    static internal class KestrelServerOptionsExtensions
    {
        public static void ConfigureServerOptions(KestrelServerOptions kestrelServerOptions, IConfiguration configuration)
        {
